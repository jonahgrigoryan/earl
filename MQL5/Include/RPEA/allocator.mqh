...
>>>>>>> a9dcc93 (Implement risk allocator with enhanced order plan structure and contract detail retrieval. Added logging for order plan decisions and refined budget gate evaluation. Updated references and comments for clarity.)
